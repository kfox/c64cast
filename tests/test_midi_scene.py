...
class LifecycleTests(_MidiTestCase):
    ...
    def test_teardown_leaves_d018_on_the_char_mode_default(self):
        ...
        # compares teardown's write to the constant it wrote it from, which
        # stayed green with that constant set to the hires $18. $14 = matrix at
        # bank+$0400, chargen at +$1000, bitmap bit clear; test_voice_scope pins
        # the constant to it.
        self.assertEqual(api.memories.get("D018"), "14")
