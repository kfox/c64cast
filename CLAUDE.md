...
| Live DJ/VJ arc — tempo/beat grid (Phase 1) + clip-launch grid (Phase 2) + layerable effect chain (Phase 3) + grid-controller LED feedback (Phase 4) | [`tempo.py`, `performance.py`](docs/architecture/control.md#performancepy--clip-launch-grid-live-djvj-phase-2), [`effects.py` chain](docs/architecture/scenes.md#the-layerable-chain-live-djvj-phase-3), [LED feedback](docs/architecture/control.md#grid-controller-led-feedback-live-djvj-phase-4) |
