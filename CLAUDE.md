...
│                     on/bri↔transport, sx/ix↔live params; one segment per
│                     ensemble system. [wled].listen; `wled` extra; cli-owned
