...
SHOT_LIST: dict[str, tuple[int, int, str, str]] = {
    ...
    "fig-ft-1-slideshow.png": (
        ...
        "python -m c64cast assets/pictures/",
    ),
    "fig-1-1-doctor.png": (
        11,
        0,
        "DOCTOR OUTPUT (TERMINAL)",
        "python -m c64cast --doctor --skip-probe",
    ),
    "fig-2-1-interstitial.png": (
        0,
        6,
        "UP NEXT INTERSTITIAL",
        "python -m c64cast --config config/c64cast.example.toml",
    ),
    "fig-2-2-wizard.png": (
        11,
        0,
    ...
    "fig-3-2-generative.png": (
        ...
        0,
        "GENERATIVE PLASMA",
        "python -m c64cast --config config/examples/scene-generative-plasma.toml",
    ),
    "fig-3-3-webcam.png": (
        0,
        0,
