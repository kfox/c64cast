...
class VisionController:
    ...
    def start(
        ...
        menu_event/menu_active/nav_queue are accepted for signature parity with
        the keyboard poller (the Playlist starts both controllers identically);
        gesture-driven menu open/nav is a later phase, so they're unused here."""
